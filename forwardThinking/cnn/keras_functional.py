...
conv2 = Conv2D(64, (3,3), activation='relu', padding='same', name='conv2')(keras.layers.concatenate([main_input, conv1], axis=3))

conv1_drop = Dropout(.35)(conv1)
conv2_max = MaxPooling2D(pool_size=(2, 2))(conv2)
conv2_drop = Dropout(.35)(conv2_max)
flat1 = Flatten()(conv1_drop)
flat2 = Flatten()(conv2_drop)
fc1 = Dense(128, activation='relu', name='fc1')(keras.layers.concatenate([flat2, flat1]))
fc1 = Dropout(.5)(fc1)
main_output = Dense(10, activation='softmax', name='fc2')(fc1)
